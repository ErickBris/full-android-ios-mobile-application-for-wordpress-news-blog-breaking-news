...
.run(function($ionicPlatform,$rootScope,$state,$ionicLoading,$localStorage,$ionicHistory,$window,$ionicPopup) {
  ...
  //   var tem = "<p style ='text-align:center;color:red'>Not Connection</p>";
  //   var isOnline = $cordovaNetwork.isOnline()
  //   var isOffline = $cordovaNetwork.isOffline()
  //   if(isOffline==true){
  //   $rootScope.showPopup(tem);
  //   }
